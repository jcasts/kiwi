...
* OPTIONS and GET methods used in Kiwi::Resource should refer to the Kiwi routes
* Swappable route parser
* Implement triggers/hooks
* Implement multi-app class
  * Allow multi-app to describe all available apps
  * Support in-Kiwi middleware for app-specific things when running multi-app
  * Middleware is pre-body serialization middleware
